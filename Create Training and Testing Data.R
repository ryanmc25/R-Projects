...
# original function used to sub-divide dataframes into training and testing sets for model testing
 # proportion of data used for training dataframe controlled by train.size argument (defaults to 70%)
...
train_test <- function(data, train.size=0.7) {
...
set2 <- train_test(salespeople, train.size = 0.5)
